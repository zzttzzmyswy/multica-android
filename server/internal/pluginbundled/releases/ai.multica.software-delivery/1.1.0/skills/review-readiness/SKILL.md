...
3. Record the tests or other evidence that directly exercise the changed behavior, including failure paths.
4. Identify migrations, compatibility constraints, rollout steps, observability, and rollback steps.
