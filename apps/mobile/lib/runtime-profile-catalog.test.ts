/**
 * Vitest port of web `packages/views/runtimes/components/runtime-profile-catalog.test.ts`
 * (iteration-82, A2.3). Keeps parse/format/validate/catalog semantics aligned
 * with web 1:1.
 */
...
describe("validateProfileForm", () => {
  it("flags missing display name and command line", () => {
    expect(validateProfileForm({ displayName: "", commandLine: "", description: "" })).toEqual([
      "displayName",
      "commandLine",
    ]);
    expect(
