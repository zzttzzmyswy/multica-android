// Iteration-99: SemVer precedence comparison for Plugin manifest versions.
// 1:1 port of packages/core/plugins/version.ts (web). Pure function, kept
// mobile-local because @multica/core/plugins only exposes its index (which
// pulls the web ApiClient + react-query chain) — importing the tiny helper
// directly avoids that dependency tree under Metro.
