/**
 * Mobile port of web `packages/views/runtimes/components/runtime-profile-catalog.ts`
 * (iteration-82, A2.3). Pure TS, no React — the create/edit form in the custom
 * runtime-profile dialog builds its catalog rows and validates the pasted
 * command line with these helpers, mirroring web semantics 1:1.
 */
import {
