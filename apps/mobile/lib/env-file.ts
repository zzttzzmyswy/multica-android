// Port of packages/views/agents/components/tabs/env-file.ts from the web app
// (kept 1:1 — same types, same parser, same serializer). Pure TS, no React
// imports, so it runs under vitest in the Node environment and is shared by
// the row editor and the bulk text editor in the agent env screen.
