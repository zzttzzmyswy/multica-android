...
describe("iteration 126 i18n", () => {
  ...
  const ZH_SPOT: Record<string, string> = {
    ...
    "skills.runtimeImport.discovering": "正在发现技能…",
    "skills.runtimeImport.searchPlaceholder": "搜索技能",
    "skills.runtimeImport.selectAll": "全选",
    "skills.runtimeImport.importing": "正在导入 {{done}}/{{total}}…",
    "skills.runtimeImport.noSelection": "请至少选择一个技能。",
