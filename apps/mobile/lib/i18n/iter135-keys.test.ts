...
describe("iteration 135 i18n", () => {
  ...
  const ZH_SPOT: Record<string, string> = {
    ...
    "resource.localRuntime": "运行机器",
    "resource.localRuntimeEmpty": "工作区还没有可用的运行机器。",
    "resource.localAlreadyAttached": "已挂载",
    "resource.modeTitle": "任务如何使用这个文件夹？",
    "resource.modeDescription": "这决定了你如何拿到智能体的工作成果，以及这个文件夹上的任务能否同时运行。",
    "resource.modeInPlaceTitle": "直接修改这个文件夹",
    "resource.modeInPlaceDescription": "一次只跑一条任务。智能体的改动会直接出现在你的工作区里，你可以接着改。",
    "resource.modeWorktreeTitle": "并行隔离运行",
    "resource.modeWorktreeDescription": "任务可以同时跑，互不干扰，也不碰你的工作区。每条任务的结果是这个仓库里的一个 agent/… 分支，由你 review 后合并。",
