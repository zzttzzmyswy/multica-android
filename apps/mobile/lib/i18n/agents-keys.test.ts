...
describe("agents list/detail i18n", () => {
  ...
  const ZH_SPOT: Record<string, string> = {
    ...
    "agents.taskCount": "{{count}} 个活跃 task",
    ...
    "agents.detail.tasks": "运行中的 task",
    "agents.detail.noTasks": "暂无活动 task。",
    "agents.activity.sectionNow": "进行中",
    "agents.activity.sectionLast30d": "最近 30 天",
    "agents.activity.sectionRecent": "最近完成",
    "agents.activity.subtitleActive": "{{count}} 个进行中 task",
    "agents.activity.subtitleNoActive": "暂无进行中的 task",
    ...
    "agents.activity.transcriptTitle": "task 执行记录",
