...
export function MarkdownToolbar({
  ...
  return (
    <View className="flex-row items-center gap-1 px-2 py-1.5 border-t border-border bg-background">
      <ToolbarButton
        accessibilityLabel={t("a11y.mention")}
        onPress={onAt}
        disabled={disabled}
      >
      ...
      <ToolbarButton
        accessibilityLabel={t("a11y.checklist")}
        onPress={onCheckbox}
        disabled={disabled}
      >
      ...
      <ToolbarButton
        accessibilityLabel={t("a11y.codeBlock")}
        onPress={onCode}
        disabled={disabled}
      >
      ...
      <ToolbarButton
        accessibilityLabel={t("a11y.quote")}
        onPress={onQuote}
        disabled={disabled}
      >
      ...
      {onImage ? (
        <ToolbarButton
          accessibilityLabel={t("a11y.attachImage")}
          onPress={onImage}
          disabled={disabled}
        >
