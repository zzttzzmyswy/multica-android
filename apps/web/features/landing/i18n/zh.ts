    ...
    entries: [
      ...
      },
      {
        ...
        features: [
          ...
          "把常用的智能体和提示词存成快捷操作，在任意 Issue 侧栏一键触发。",
          "粘贴 Issue 或项目链接，会直接显示成卡片，不再是一长串网址。",
        ...
        fixes: [
          ...
          "很长的 Issue 时间线不再停在过去，最新动态都能看到。",
          "智能体拆出子 Issue 时，订阅的人现在会收到通知。",
          "自托管改用自定义端口后，启动和连接不再对不上。",
          "用量排行榜里单个智能体的数字，不再超过同期总量。",
          "工作中的智能体数量，现在只算筛选出的 Issue，不再算整个工作区。",
          "超大的消息不再影响实时连接的稳定。",
          "自托管升级到新版本不再中途失败。",
