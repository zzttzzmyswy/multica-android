      ...
      entries: [
        {
          ...
          fixes: [
            ...
            "チャットの /issue で作成した Issue の更新が、通知として届くようになりました。",
            "Aliyun OSS と Tencent COS への添付ファイルのアップロードが失敗しなくなりました。",
            "プロキシ経由でしかインターネットに出られないマシンでも、タスクをすぐ受け取れます。",
        ...
        },
        {
          ...
          features: [
            ...
            "よく使うエージェントとプロンプトを保存し、どの Issue のサイドバーからでも実行できます。",
            "Issue やプロジェクトの URL を貼ると、長いリンクではなくカードで表示されます。",
          ...
          fixes: [
            ...
            "長い Issue のタイムラインが途中で止まらず、最新の動きまで表示されます。",
            "エージェントが子 Issue を作成すると、購読者に通知が届きます。",
            "セルフホストでポートを変更しても、起動と接続が正しく行われます。",
            "使用量ランキングの個別エージェントが、全体の合計を超えなくなりました。",
            "作業中のエージェント数が、ワークスペース全体ではなく絞り込んだ Issue の分だけになりました。",
