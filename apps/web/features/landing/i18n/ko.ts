      ...
      entries: [
        {
          ...
          fixes: [
            ...
            "Issue의 구독 해제가 실제로 적용됩니다.",
            "답글 입력창에서 / 를 입력하면 워크스페이스의 빠른 작업도 표시됩니다.",
            "Issue 헤더에서 실행 중인 로그를 열어도 바로 닫히지 않습니다.",
            ...
            "Issue를 스쿼드에 지정해도 오류가 발생하지 않습니다.",
          ],
        },
        {
          version: "0.4.17",
          ...
          improvements: [
            ...
            "Issue 사이드바가 실행 로그를 먼저 보여 주고 상세 정보는 그 아래로 내려갔습니다.",
          ...
          fixes: [
            ...
            "채팅에서 /issue로 만든 Issue의 소식이 알림으로 옵니다.",
        ...
        },
        {
          ...
          features: [
            ...
            "자주 쓰는 에이전트와 프롬프트를 저장해 두고, 어떤 Issue의 사이드바에서든 실행할 수 있습니다.",
            "Issue나 프로젝트 링크를 붙여 넣으면 긴 주소 대신 카드로 표시됩니다.",
          ...
          fixes: [
            ...
            "긴 Issue의 타임라인이 과거에서 멈추지 않고 최신 활동까지 보여 줍니다.",
            "에이전트가 하위 Issue를 만들면 구독자에게 알림이 갑니다.",
            "셀프 호스팅에서 포트를 바꿔도 실행과 연결이 어긋나지 않습니다.",
            "사용량 순위의 개별 에이전트 수치가 전체 합계를 넘지 않습니다.",
            "작업 중인 에이전트 수가 워크스페이스 전체가 아니라 필터링한 Issue 기준으로 표시됩니다.",
