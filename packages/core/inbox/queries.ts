...
/**
 * The two cross-workspace derivations live in `./unread-summary` because
 * mobile imports them too and must not pull this module's ApiClient /
 * React Query imports into its bundle. Re-exported here so web's existing
 * import path is unchanged and there is no second copy to drift.
 */
export { hasOtherWorkspaceUnread, unreadWorkspaceIds } from "./unread-summary";
